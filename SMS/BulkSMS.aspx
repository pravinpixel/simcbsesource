                              ...
                              <tr>
                                ...
                                <tr>
                                    <td>
                                        <b>Message By</b></td>
                                    <td>
                                        <input type="radio" checked="checked" class="Mess" id="MsgText" onclick="MessageType();" name="mes" />Entry 
                                        <input type="radio" class="Mess" id="msgTemplate" name="mes" onclick="MessageType();" />Template
                                         <asp:DropDownList ID="ddlTemplate" onchange="GetMessageTemplate();" 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtMessage"  Rows="5" Columns="30" MaxLength="160" runat="server" data-maxsize="160" data-output="status1"
                                ...
                                <tr>
                                    ...
                                    <td id="buttonCss">
                                       <%-- <button id="btnSubmit" type="button" class="btn-icon btn-navy btn-save" onclick="SavePermission();">
                                          ...
                                          <asp:Button ID="btnSearch" runat="server" class="btn-icon btn-navy btn-send" 
