<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="IndividualSMS.aspx.cs" Inherits="IndividualSMS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head2" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetMessageTemplate() {
            if ($("[id*=hfViewPrm]").val() == 'true') {
                ...
                if (MessTempID != "") {
                    $.ajax({
                        type: "POST",
                        url: "../SMS/IndividualSMS.aspx/GetMessageTemplate",
        ...
        function GetSection(ID) {
            $.ajax({
                type: "POST",
                url: "../SMS/IndividualSMS.aspx/GetSectionByClassID",
                data: '{ClassID: ' + ID + '}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function OnGetSectionByClassSuccess(response) {
            ...
            select.append($("<option>").val('').text('---Select---'));
             select.append($("<option>").val('0').text('New'));
            $.each(cls, function () {
                var icls = $(this);
        ...
        function GetStudents() {
            $.ajax({
                type: "POST",
                url: "../SMS/IndividualSMS.aspx/GetStudents",
                data: '{"classId": "' + $("[id*=ddlClass]").val() + '","sectionId": "' + $("[id*=ddlSection]").val() + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
...
<%--Save SMS--%>
        ...
        function SaveSMS() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../SMS/IndividualSMS.aspx/SaveSMS",
                        data: parameters,
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
