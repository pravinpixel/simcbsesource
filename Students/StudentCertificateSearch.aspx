            ...
            if ($("[id*=hfEditPrm]").val() == 'true') {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        var url = "../Students/StudentCertificateEntry.aspx?menuId=" + $("[id*=hdnMenuIndex]").val() + "&activeIndex=" + $("[id*=hdnIndex]").val() + "&moduleId=" + $("[id*=hfModuleID]").val() + "&StudentID=" + StudentInfoID + "";
