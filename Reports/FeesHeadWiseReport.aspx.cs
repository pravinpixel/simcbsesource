...
public partial class Reports_FeesHeadWiseReport : System.Web.UI.Page
{
    string sDate = "";
    string eDate = "";
    Utilities utl = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            FeesHeadWiseReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            FeesHeadWiseReport.LocalReport.SetParameters(new ReportParameter[] { Startdate });
            FeesHeadWiseReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
            FeesHeadWiseReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        FeesHeadWiseReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
        FeesHeadWiseReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
        FeesHeadWiseReport.LocalReport.Refresh();
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(FeesHeadWiseReport.LocalReport);
