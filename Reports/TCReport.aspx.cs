...
public partial class Reports_TCReport : System.Web.UI.Page
{
    string strClass = "";
    string strSection = "";
    string strClassID = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            TCReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            TCReport.LocalReport.SetParameters(new ReportParameter[] { Startdate });
            TCReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
            TCReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        TCReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
        TCReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
        TCReport.LocalReport.SetParameters(new ReportParameter[] { className });
        TCReport.LocalReport.SetParameters(new ReportParameter[] { Startdate });
        TCReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });

        TCReport.LocalReport.Refresh();
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(TCReport.LocalReport);
