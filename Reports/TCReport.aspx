<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="TCReport.aspx.cs" EnableViewState="true" Inherits="Reports_TCReport" %>
                    ...
                    <asp:UpdatePanel ID="ups" runat="server">
                        <ContentTemplate>
                            <table align="left">
                                ...
                                <tr>
                                    <td align="center">
                                        <rsweb:ReportViewer ID="TCReport" runat="server" Font-Names="Verdana" Font-Size="8pt"
                                            InteractiveDeviceInfos="(Collection)" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt"
                                            Width="1000px">
                                            <LocalReport ReportPath="Rpt\TCReport.rdlc">
                                                <DataSources>
                                        ...
                                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                                            SelectMethod="GetData" TypeName="dsTCTableAdapters.DataTable1TableAdapter">
                                            <SelectParameters>
                        ...
                        <Triggers>
                            <asp:PostBackTrigger ControlID="TCReport" />
