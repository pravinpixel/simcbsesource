...
public partial class Reports_RetirementStaffReport : System.Web.UI.Page
{
    string sDate = "";
    string eDate = "";
    Utilities utl = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            RetirementStaffReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            RetirementStaffReport.LocalReport.SetParameters(new ReportParameter[] { Startdate });
            RetirementStaffReport.LocalReport.SetParameters(new ReportParameter[] { Enddate });
            RetirementStaffReport.LocalReport.SetParameters(new ReportParameter[] { Printdate });
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        RetirementStaffReport.LocalReport.Refresh();
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(RetirementStaffReport.LocalReport);
