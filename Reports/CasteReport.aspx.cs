...
public partial class Reports_CasteReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            CasteReport.LocalReport.SetParameters(new ReportParameter[] { Schoolname });
            CasteReport.LocalReport.SetParameters(new ReportParameter[] { PrintDate });
            CasteReport.LocalReport.Refresh();
        }
    }
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        Export(CasteReport.LocalReport);
